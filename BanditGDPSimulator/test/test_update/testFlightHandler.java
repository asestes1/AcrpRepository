...
public class testFlightHandler extends TestCase{
	...
	public void testAirHold() throws Exception{
		...
		DateTime startTime = new DateTime(2011,12,12,10,03,DateTimeZone.UTC);
		...
		FlightState myState = FlightStateFactory.parseFlightState(flightsFile, runInterval,DateTimeZone.UTC, FlightFactory.BASIC_FORMAT_ID);
	...
	public void testEnRouteDelay() throws Exception{
		...
		Interval runInterval = new Interval(currentTime,currentTime.plus(Duration.standardHours(24)));
